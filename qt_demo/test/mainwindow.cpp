            ...
            QImage simage("E:/Qt/qtworks/MainWindow/images/name1.png");
                   ...
                   for(int i=0; i<sheight; ++i) {
                       for(int j=0; j<swidth; ++j) {
                          ...
                          {
                              //images.setPixelColor(j,i,qRgb(red,blue,green));
                          }
                       }
...
void MainWindow::on_action_V_triggered()
{
    ...
    ui->pushButton_6->setStyleSheet("border-radius:32px;"
                                             "background-images: url(:/myImage/images/stop.png);border:none;") ;
    }
}
...
void MainWindow::on_pushButton_6_clicked()
{
    if(isstart)
    {
        ...
        isstart=false;
        ui->pushButton_6->setStyleSheet("border-radius:32px;"
                                                 "background-images: url(:/myImage/images/start.png);border:none;") ;
    }else {
        timer.start(delay);
        isstart=true;
        ui->pushButton_6->setStyleSheet("border-radius:32px;"
